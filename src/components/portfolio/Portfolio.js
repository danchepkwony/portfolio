...
import poster from '../images/research_poster.png';
...
const PortfolioPage = ( props ) => {
  ...
  var Projects = {
                lsampResearch: <Project title = {projects.LSAMPResearch.title} description = {projects.LSAMPResearch.description} skills = {projects.LSAMPResearch.skills} img = {poster} hasDownload = {true}/>,
                communicaid: <Project title = {projects.Communicaid.title} description = {projects.Communicaid.description} skills = {projects.Communicaid.skills} img = {communicaid} hasLink = {true} link = {projects.Communicaid.link}/>,
